...
<TITLE>火灾预防警报管理系统</TITLE>     <!-- Bootstrap core CSS -->
...
<SPAN class="icon-bar"></SPAN><SPAN class="icon-bar"></SPAN><SPAN class="icon-bar"></SPAN></BUTTON> 
          <A class="navbar-brand" href="#" target="_blank">火灾预防警报管理系统</A> 
        </DIV>
...
<UL class="nav nav-sidebar">
  ...
  <LI><A class="accordion-toggle collapsed" href="#" data-toggle="collapse" data-target="#mastersubmenu">仓库数据监控</A>
  <UL class="nav collapse" id="mastersubmenu" style="padding-left: 20px;">
    <LI><A href="typeAdd.php">温湿度监控</A></LI>
    <LI><A href="typeList.php">室内气体浓度监控</A></LI>
  </UL>
  </LI>

   <LI><A class="accordion-toggle collapsed" href="#" data-toggle="collapse" data-target="#mastersubmenu1">历史仓库数据</A>
  <UL class="nav collapse" id="mastersubmenu1" style="padding-left: 20px;">
    <LI><A href="videoAdd.php">温湿度数据</A></LI>
    <LI><A href="videoList.php">气体浓度数据</A></LI>
  </UL>
  </LI>
